...
public class TampilImplicitIntent extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tampil_implicit_intent);
    }
    ...
    public void tampilKalkulator(View view) {
        ...
        if (item_size >= 1)
        {
            ...
            Toast.makeText(getApplicationContext(), "Tidak ditemukan aplikasi kal;", Toast.LENGTH_SHORT).show();
        }
    }
